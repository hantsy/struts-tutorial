...
<div id="content">
    <html:form action="/register.do" method="post"  onsubmit="return validateUserForm(this);">
        ...
        <div><label>Gender</label><html:radio property="gender" value="Male"/>Male<html:radio property="gender" value="Female"/>Female</div>   
        <div><label>Email</label><html:text property="email"/></div>   
        <div><label>Birthday</label><html:text property="birthday"/></div>
        <div><label>Infomation is Public to others?</label><html:checkbox property="agreeToPublic"/></div>
